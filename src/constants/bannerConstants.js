...
export const ADMIN_BANNERS_REQUEST = "ADMIN_BANNERS_REQUEST";
export const ADMIN_BANNERS_SUCCESS = "ADMIN_BANNERS_SUCCESS";
export const ADMIN_BANNERS_FAIL = "ADMIN_BANNERS_FAIL";
