            ...
            <Box sx={{ mb: 6, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                <Box>
                    ...
                    <Typography variant="h4" sx={{ fontWeight: 950, color: '#020617', letterSpacing: '-0.03em', textTransform: 'uppercase' }}>
                        All <span style={{ color: '#0f52ba' }}>Sub-Categories</span>
                    </Typography>
                </Box>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <p className="text-[9px] font-black text-blue-900/40 uppercase tracking-[0.2em]">{openAddModal ? 'New' : 'Update'} Sub-Category</p>
                            </div>
                            <Typography variant="h5" sx={{ fontWeight: 950, color: '#020617', textTransform: 'uppercase' }}>
                                {openAddModal ? 'Add' : 'Edit'} <span style={{ color: '#0f52ba' }}>Sub-Category</span>
                            </Typography>
                        </Box>
                ...
                <DialogContent sx={{ px: 6, py: 4 }}>
                    <div className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-blue-900/30 uppercase tracking-widest ml-1">Sub-Category Name</label>
                            <TextField
                                fullWidth
                                variant="outlined"
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-blue-900/30 uppercase tracking-widest ml-1">Category Type</label>
